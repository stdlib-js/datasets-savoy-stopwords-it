...
```bash
npm install @stdlib/datasets-savoy-stopwords-it
```
...
```bash
npm install -g @stdlib/datasets-savoy-stopwords-it
```
...
[test-image]: https://github.com/stdlib-js/datasets-savoy-stopwords-it/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/datasets-savoy-stopwords-it/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/datasets-savoy-stopwords-it
...
[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/datasets-savoy-stopwords-it/main/LICENSE
